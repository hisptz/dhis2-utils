...
import {evaluateFromDataExpression} from '../../../utils/programRules/utils';
import {UseFormSetError, UseFormUnregister} from 'react-hook-form';
import type {OptionGroup} from '@hisptz/dhis2-utils';
...
export interface ActionCallbacks {
    ...
    toggleFieldDisabled: (field: { field: string; disabled?: boolean }[]) => void;
    setMinMax: (
        field: {
            field: string;
            min?: number | string;
