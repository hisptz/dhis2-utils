                ...
                (rule) =>
                    !some(
                        ...
                        (trigger) =>
                            ...
                            (isEnrollmentForm && trigger.type === 'TEI_ATTRIBUTE')
                    )
            ),
        [isEnrollmentForm, rules]
    );
