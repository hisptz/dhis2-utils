				...
				return (
						<div>
								<DataTable className={cx(classes.table, {
										...
										<DataTableHead>
												<DataTableRow>
														{selectable && (<DataTableColumnHeader fixed top>
																		...
																		>
																				{!loading && isEmpty(rows) && (
																						<h3 style={{color: colors.grey700}}>
																								{emptyLabel ??
																										i18n.t("There is no data for the specified filters")}
																						</h3>
																				)}
																		</div>
																</td>
												...
												) : null}
												{
														rows?.map((data, index) => (
																<DataTableRow
																		...
																		{selectable && (<DataTableCell {...(data.cellsStyle ?? {})} width="48px">
