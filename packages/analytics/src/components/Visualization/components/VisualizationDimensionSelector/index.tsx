...
export function VisualizationDimensionSelector({showPeriodSelector, showOrgUnitSelector}: {
		...
		return (
				<>
						<div style={{display: "flex", gap: 8}}>
								{
										showPeriodSelector && (<Tooltip content={i18n.t("Period")}>
												<>
														<PeriodSelectorModal
																position="middle"
								...
								{
										showOrgUnitSelector && (<Tooltip content={i18n.t("Location")}>
												<>
