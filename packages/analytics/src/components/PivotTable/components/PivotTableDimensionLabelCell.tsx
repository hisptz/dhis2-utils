...
export const PivotTableDimensionLabelCell = ({rowLevel, columnLevel}: PivotTableDimensionLabelCellProps) => {
    ...
    return (<PivotTableCell isHeader={true} classes={[
        "empty-header",
        "column-header",
        {
    ...
    ]} colSpan={colSpan} rowSpan={rowSpan} title={label} style={style}>
        {label}
    </PivotTableCell>);
};
