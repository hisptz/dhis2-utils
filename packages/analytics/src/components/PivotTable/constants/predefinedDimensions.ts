...
import AssignedCategoriesIcon from "../components/AssignedCategoriesIcon";
...
export const getPredefinedDimensionProp = (dimensionId: "ou" | "pe" | "dx", propName: "id" | "name" | "iconName") =>
    (getPredefinedDimensions()[dimensionId] || {})[propName]

export const getDimensionById = (dimensionId: "ou" | "pe" | "dx") =>
