...
import {OrgUnitSelectorProps} from "@hisptz/dhis2-ui/build/types/components/selectors/OrgUnitSelector/types";
import {ModalProps, OrgUnitSelector, OrgUnitSelectorModal} from "@hisptz/dhis2-ui";

const Template: Story<OrgUnitSelectorProps> = (args) => <OrgUnitSelector {...args} />;


const ModalTemplate: Story<ModalProps & OrgUnitSelectorProps> = (args) => <OrgUnitSelectorModal {...args} />;
...
export default {
    ...
    component: [OrgUnitSelector, OrgUnitSelectorModal],
    decorators: [
        (Story: any) => (
            <Story/>
        ),
