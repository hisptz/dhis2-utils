...
import {Period, PeriodConfig, PeriodFilterFn, WeekObject} from "../interfaces";
...
const getDailyPeriodType = (formatYyyyMmDd: (value: Date) => string, fnFilter: any) => {
    return (config: any) => {
        let periods: Period[] = []
...
const getWeeklyPeriodType = (formatYyyyMmDd: (value: Date) => string, weekObj: WeekObject, fnFilter: PeriodFilterFn) => {
    // Calculate the first date of an EPI year base on ISO standard  ( first week always contains 4th Jan )
    const getEpiWeekStartDay = (year: number, startDayOfWeek: number) => {
...
const getBiWeeklyPeriodType = (formatYyyyMmDd: (value: Date) => string, fnFilter: PeriodFilterFn) => {
    return (config: PeriodConfig) => {
        let periods: Period[] = []
        const offset = parseInt(config.offset ?? '', 10)
        const isFilter = config.filterFuturePeriods
...
const getMonthlyPeriodType = (formatYyyyMmDd: (value: Date) => string, fnFilter: PeriodFilterFn) => {
...
const getBiMonthlyPeriodType = (formatYyyyMmDd: (value: Date) => string, fnFilter: PeriodFilterFn) => {
    return (config: PeriodConfig) => {
        let periods: Period[] = []
        const offset = parseInt(config.offset ?? '', 10)
        const isFilter = config.filterFuturePeriods
...
const getQuarterlyPeriodType = (formatYyyyMmDd: (value: Date) => string, fnFilter: PeriodFilterFn) => {
    return (config: PeriodConfig) => {
        let periods: Period[] = []
        const offset = parseInt(config.offset ?? '', 10)
        const isFilter = config.filterFuturePeriods
...
const getSixMonthlyPeriodType = (fnFilter: PeriodFilterFn) => {
    return (config: PeriodConfig) => {
        let periods: Period[] = []
        const offset = parseInt(config.offset ?? '', 10)
        const isFilter = config.filterFuturePeriods
...
const getSixMonthlyAprilPeriodType = (fnFilter: PeriodFilterFn) => {
    return (config: PeriodConfig) => {
        let periods: Period[] = []
        const offset = parseInt(config.offset ?? '', 10)
        const isFilter = config.filterFuturePeriods
...
const getYearlyPeriodType = (formatYyyyMmDd: (value: Date) => string, fnFilter: PeriodFilterFn) => {
    return (config: PeriodConfig) => {
        let periods: Period[] = []
        const offset = parseInt(config.offset ?? '', 10)
        const isFilter = config.filterFuturePeriods
...
const getFinancialOctoberPeriodType = (formatYyyyMmDd: (value: Date) => string, fnFilter: PeriodFilterFn) => {
    return (config: PeriodConfig) => {
        let periods: Period[] = []
        const offset = parseInt(config.offset ?? '', 10)
        const isFilter = config.filterFuturePeriods
...
const getFinancialNovemberPeriodType = (formatYyyyMmDd: (value: Date) => string, fnFilter: PeriodFilterFn) => {
    return (config: PeriodConfig) => {
        let periods: Period[] = []
        const offset = parseInt(config.offset ?? '', 10)
        const isFilter = config.filterFuturePeriods
...
const getFinancialJulyPeriodType = (formatYyyyMmDd: (value: Date) => string, fnFilter: PeriodFilterFn) => {
    return (config: PeriodConfig) => {
        let periods: Period[] = []
        const offset = parseInt(config.offset ?? '', 10)
        const isFilter = config.filterFuturePeriods
...
const getFinancialAprilPeriodType = (formatYyyyMmDd: (value: Date) => string, fnFilter: PeriodFilterFn) => {
    return (config: PeriodConfig) => {
        let periods: Period[] = []
        const offset = parseInt(config.offset ?? '', 10)
        const isFilter = config.filterFuturePeriods
...
const filterFuturePeriods = (periods: Period[]) => {
    const array = []
